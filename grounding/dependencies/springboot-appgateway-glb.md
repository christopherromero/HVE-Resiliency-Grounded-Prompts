...
# Application Gateway and Global Load Balancer Behavior Target-State Application Behavior Standard
...
```text
architecture_context.shared_service_operating_models.services.appgateway_glb
```
...
- Resolve source and target models from `architecture_context.shared_service_operating_models.services.appgateway_glb` before evaluating model-specific controls.
